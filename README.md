...
Входные данные функции Дейкстра:
...
Входные данные программы:
    ...
    Целое число n, идентифицирующий количество вершин графа
    
    Целое число start, идентифицирующее начальную вершину.

    Целое число end, идентифицирующее конечную вершину.
    
    Список ориентированных рёбер ribs, каждое из которых задаётся тройкой целых чисел (u, v, w), где u — начальная вершина, v — конечная вершина, w — вес ребра.
