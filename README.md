...
Входные данные программы:
    ...
    Целое число, идентифицирующее начальную вершину.

    Целое число, идентифицирующее конечную вершину.
    
    Список ориентированных рёбер, каждое из которых задаётся тройкой целых чисел (u, v, w), где u — начальная вершина, v — конечная вершина, w — вес ребра.
